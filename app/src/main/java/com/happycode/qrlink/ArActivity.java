...
import com.happycode.qrlink.ar.libgdx.Engine;
import com.happycode.qrlink.ar.vuforia.AppSession;
import com.happycode.qrlink.ar.vuforia.SessionControl;
import com.happycode.qrlink.ar.vuforia.VuforiaException;
import com.happycode.qrlink.ar.vuforia.VuforiaRenderer;
...
public class ArActivity extends AndroidApplication implements SessionControl {
    ...
    public boolean doUnloadTrackersData() {
        ...
        if (posterDataSet != null) {
            if (imageTracker.getActiveDataSet(1) == posterDataSet && !imageTracker.deactivateDataSet(posterDataSet)) {
